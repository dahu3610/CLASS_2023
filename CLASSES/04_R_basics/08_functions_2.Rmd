...
library(tidyverse)
library(IRanges)
#Source import peaks function, need to make sure you have correct working directory set or use full file path. Have to be in 04_R_basics for this code to work
...
consensus_from_reduced <- function(dbps, peak_list) {

...
path <- "/results/bwa/mergedLibrary/macs/broadPeak"

# first we read the peak files in as gRanges object with rtracklayer function.
peaks1 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R1_peaks.broadPeak"))
peaks2 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R2_peaks.broadPeak"))
peaks3 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R3_peaks.broadPeak"))
peaks4 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R4_peaks.broadPeak"))

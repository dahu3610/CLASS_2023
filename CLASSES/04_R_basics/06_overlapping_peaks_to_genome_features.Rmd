...
promoter_overlaps_CEBPB_peaks1 <- findOverlaps(peaks1, gencode_promoters)
# Let's look
promoter_overlaps_CEBPB_peaks1

# nice we see that 19,063 promoters overlap with Pol2 replicate 1.
# Let's try the same for replicate 2:

promoter_overlaps_CEBPB_peaks2 <- findOverlaps(peaks2, gencode_promoters)
# Let's look
promoter_overlaps_CEBPB_peaks2
...
same_prom_ov12 <- findOverlaps(promoter_overlaps_CEBPB_peaks1, promoter_overlaps_CEBPB_peaks2)
...
# indexing
peak1_ov_gr <- peaks1[unique(promoter_overlaps_CEBPB_peaks1@from)] 

# indexing
peak2_ov_gr <- peaks2[unique(promoter_overlaps_CEBPB_peaks2@from)]

# now let's find the overlaps of the overlaps
ov_of_ov12 <- findOverlaps(peak1_ov_gr, peak2_ov_gr)
ov_of_ov12
...
promoter_overlaps_CEBPB_peaks1 <- subsetByOverlaps(peaks1, gencode_promoters)
...
promoter_overlaps_CEBPB_peaks2 <- subsetByOverlaps(peaks2, gencode_promoters)
# Let's look
promoter_overlaps_CEBPB_peaks2
# 14,403 = same as before with findOverlaps

# now overlapping the two overlaps by findOverlaps
subset_overlaps_peaks <- findOverlaps(promoter_overlaps_CEBPB_peaks1, promoter_overlaps_CEBPB_peaks2)
...
consensus12 <- subsetByOverlaps(peaks1, peaks2)
consensus12
# 27,206 
peaks1
# 33,582
...
# Ok so we something similar to R_basics/03_
...
CEBPB_R1 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R1_peaks.broadPeak"))
CEBPB_R2 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R2_peaks.broadPeak"))
CEBPB_R3 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R3_peaks.broadPeak"))
CEBPB_R4 <- rtracklayer::import(file.path(basepath,path, "CEBPB_R4_peaks.broadPeak"))
...
CEBPB_ov1 <- subsetByOverlaps(CEBPB_R1, CEBPB_R2) 
#38,409 overlaps
CEBPB_ov2 <- subsetByOverlaps(CEBPB_ov1, CEBPB_R3)
# 11,020 (got much smaller since R3 has only 14K peaks)
CEBPB_ov3 <- subsetByOverlaps(CEBPB_ov2, CEBPB_R4)
# 8,160 (even smaller since we reduced to 11K above)
length(CEBPB_ov3)
# 12537 consesus peaks among all 4 replicates

#Excluding Rep 2
CEBPB_ov_ex2_1 <- subsetByOverlaps(CEBPB_R1, CEBPB_R3) 
#38,409 overlaps
CEBPB_ov_ex2_2 <- subsetByOverlaps(CEBPB_ov1, CEBPB_R4)
length(CEBPB_ov_ex2_2)

CEBPB_consensus_ov_prom <- findOverlaps(CEBPB_ov_ex2_2, gencode_promoters)
length(CEBPB_ov_ex2_2)
length(gencode_promoters)
CEBPB_consensus_ov_prom
length(CEBPB_consensus_ov_prom)

table(table(CEBPB_consensus_ov_prom@from))
table(table(CEBPB_consensus_ov_prom@to))

#Finding overlap with gene bodies
CEBPB_consensus_ov_genes <- findOverlaps(CEBPB_ov_ex2_2, gencode_genes)
length(CEBPB_ov_ex2_2)
length(gencode_genes)
CEBPB_consensus_ov_genes
length(CEBPB_consensus_ov_genes)
(length(CEBPB_consensus_ov_genes))/(length(CEBPB_ov_ex2_2))

#Overlap between promoter overlaps and gene body overlaps
CEBPB_consensus_ov_genesANDprom <- subsetByOverlaps(CEBPB_consensus_ov_genes, CEBPB_consensus_ov_prom)

...
library(tidyverse)
library(IRanges)
source("../../../util/BCHM5631_class_functions.R")
...
# merge into num_peaks, merges based on the dbp column in both
...
```{r reading .bed file from rtracklayer_export}
# FIRST a file list:
consensus_file_list <- list.files("/scratch/Shares/rinnclass/CLASS_2023/dahu3610/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/consensus_peaks", full.names = T, pattern = ".bed")
